...
<script>
import { selectLiteratureDownTop } from '@/service/literature'
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      selectLiteratureDownTop(this.searchName, (this.currentPage - 1) * this.pagesize, this.pagesize).then(response => {
